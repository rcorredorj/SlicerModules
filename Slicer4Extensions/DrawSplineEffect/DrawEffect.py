...
comment = """
  ...
  DrawEffect is a subclass of DrawEffect
...
#
# DrawEffectOptions - see DrawEffect, EditOptions and Effect for superclasses
#
...
class DrawEffectLogic(LabelEffect.LabelEffectLogic):
  ...
  def addFiducial(self,ras):
    ...
    self.fiducials.AddFiducial(ras[0],ras[1],ras[2])
